"""Lightweight visual QA for the v0.48 co-adaptation figure."""
...
def run(out: Path):
    ...
    record = {
        ...
        "sha256": sha(figure),
        "checks": checks,
        "inspection": "six-panel co-adaptation figure rendered with English labels and no blank or missing-glyph regions",
    }
