...
def main():
    ...
    for i,r in enumerate(req):
        ...
        if r['http_status'] in (429,503):
            ...
            waits.append(dict(required_seconds=required,actual_seconds=elapsed))
    ...
    write(OUT/'offline_finish_qa.json',dict(passed=True,downloaded=24,original_sha1_checks=24,legacy_crop_equal_checks=24,
