...
最新完成[v0.13私人空间能力与共同符号形成](redesign_v0.13/results/spatial_001/私人空间能力与共同符号形成研究报告.md)：24组私人主体对训练后接24组通信学习。两组私人未训练组合双目标能力约95%，社会熟悉组合约97%；主要未训练组合的自然通信为22.04%与19.87%，增加空间一致性约束后四个来源2升2降，未显示稳定收益。对照的私人能力本来已强，新增约束的能力操纵很小。完整执行、分析、原始行为重算和固定消息样例见[v0.13复现索引](redesign_v0.13/README.md)。
