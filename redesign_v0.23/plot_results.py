...
def main():
    ...
    fig.suptitle('Private experience coverage and new communication',fontsize=15)
    fig.supxlabel('Points: four source seeds; black marks: means. Target12 is communication-unseen in A/B, trained in C.',fontsize=10)
    ...
    axes[0].legend(fontsize=8,loc='best');fig.suptitle('Communication learning at matched update budgets',fontsize=15)
