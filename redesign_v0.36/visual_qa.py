"""Deterministic raster QA for v0.36 figures."""
...
def main():
    parser = argparse.ArgumentParser(); parser.add_argument("--out", type=Path, required=True); args = parser.parse_args(); out = args.out.resolve(); directory = out / "figures"; names = ("01_iterated_outcomes.png",); figures = {}; checks = []
    for name in names:
        path = directory / name
