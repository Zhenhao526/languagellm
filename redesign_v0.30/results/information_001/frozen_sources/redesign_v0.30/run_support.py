...
def source_hashes():
    ...
    files += [PROJECT/n for n in ('paper_program/nonmatching_design_20260916/nonmatching_candidates.json','redesign_v0.28/world.py',
...
def main():
    ...
    write(out/'invocation.json',dict(formal=not args.dev,seeds=seeds,partitions=parts,updates=args.updates,source=str(source),source_hashes=hashes,input_hashes=inputs,
        ...
        primary='target12 pooled J at2400 connected_cycle12 minus three_products; nested source / panels / directions / masks',
        study_scope='fixed_budget_development_nonmatching_support_and_information',new_private_fits=0,test_worlds=180,train_worlds=720))
