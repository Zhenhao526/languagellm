"""Lightweight visual QA for the v0.43 six-panel figure."""
...
def run(out: Path):
    ...
    record = {
        ...
        "sha256": sha(figure),
        "checks": checks,
        "inspection": "six-panel permutation/role figure rendered with English labels and no missing-glyph boxes",
    }
