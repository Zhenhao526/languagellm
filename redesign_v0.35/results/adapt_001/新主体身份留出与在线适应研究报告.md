...
形式执行记录见 [invocation.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.35/results/adapt_001/invocation.json)，训练完成记录见 [training_complete.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.35/results/adapt_001/training_complete.json)。
...
|---|---|---:|---:|---:|
| fixed_A | A | 3.646%（5.130%） | 6.655%（7.438%） | 8.681%（9.906%） |
| fixed_A | B | 2.951%（4.705%） | 1.013%（2.542%） | 1.736%（4.283%） |
| fixed_A | C | 2.951%（5.009%） | 1.360%（2.785%） | 1.042%（2.649%） |
| rotating_AB | A | 4.340%（5.699%） | 5.874%（6.579%） | 4.688%（6.581%） |
| rotating_AB | B | 3.993%（5.433%） | 5.527%（6.473%） | 6.163%（7.023%） |
| rotating_AB | C | 4.167%（4.862%） | 4.167%（5.563%） | 3.848%（5.127%） |
...
零样本原始统计：[identity_analysis.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.35/results/identity_001/identity_analysis.json)；独立审计：[identity_audit.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.35/results/identity_001/identity_audit.json)。
...
|---|---|---:|---:|---:|
| fixed_A | A | 13.166%（4.880%） | 45.920%（7.472%） | 42.321% |
| fixed_A | B | 1.852%（2.166%） | 2.387%（2.369%） | 2.282% |
| fixed_A | C | 1.982%（1.739%） | 1.577%（2.138%） | 1.386% |
| rotating_AB | A | 10.084%（5.211%） | 31.105%（9.832%） | 28.953% |
| rotating_AB | B | 10.648%（4.753%） | 31.829%（9.677%） | 29.387% |
| rotating_AB | C | 5.903%（3.099%） | 14.815%（8.469%） | 13.590% |
...
|---|---:|
| A | -14.815 个百分点（SD 9.390%）|
| B | +29.442 个百分点（SD 10.575%）|
| C | +13.238 个百分点（SD 8.915%）|
...
| 私有类型 | A | B | C |
|---|---:|---:|---:|
| 0 | 31.539% | 32.812% | 14.265% |
| 1 | 30.671% | 30.845% | 15.365% |
...
在线适应独立重算通过 97502 项检查和 20736 个标量比较，最大指标误差为 0.0；覆盖 2,304 张协议表。边界审计通过 41826 项检查，覆盖 92160 行 trace、96 个 trace 文件。

图形：[01_adaptation_outcomes.png](/Users/xia/Documents/ChatGPT/语言/redesign_v0.35/results/adapt_001/figures/01_adaptation_outcomes.png)；图形源数据：[figure_source.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.35/results/adapt_001/figures/figure_source.json)；视觉 QA：[visual_qa.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.35/results/adapt_001/figures/visual_qa.json)。
在线适应分析：[adaptation_analysis.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.35/results/adapt_001/adaptation_analysis.json)；独立重算：[adaptation_raw_validation.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.35/results/adapt_001/adaptation_raw_validation.json)；轨迹审计：[adaptation_audit.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.35/results/adapt_001/adaptation_audit.json)。
零样本分析：[identity_analysis.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.35/results/identity_001/identity_analysis.json)；零样本审计：[identity_audit.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.35/results/identity_001/identity_audit.json)。
设计文件：[adaptation_design.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.35/adaptation_design.json)；执行源文件：[newcomer_adaptation.py](/Users/xia/Documents/ChatGPT/语言/redesign_v0.35/newcomer_adaptation.py)。
