...
- [冻结方案](plan.md)
- [执行结果与下一步](结果与下一步.md)
- [独立审计](results/partner_probe_001/audit_001/verification.json)
- [JSON-only汇总](results/partner_probe_001/aggregation_001/results.json)
- [图表收据](results/partner_probe_001/figures_001/receipt.json)

`partner_probe_001`是本包复合需求设计的权威运行；单轴方向探针的`probe_001`/`probe_002`保留在相邻包中，不混入本包统计。
