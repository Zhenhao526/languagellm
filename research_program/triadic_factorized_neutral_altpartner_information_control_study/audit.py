...
def main(source, output):
    ...
    for seed in design.SEEDS:
        ...
        for condition in design.CONDITIONS:
            ...
            require(run['seed'] == seed and run['condition'] == condition and run['information'] == information
                    and run['updates'] == 6000, 'Run identity mismatch')
            for row in run['trajectory']:
                ...
                replay = runner.evaluate_factorized(networks, arrays['train'], static['partitions']['train'], information, live)
