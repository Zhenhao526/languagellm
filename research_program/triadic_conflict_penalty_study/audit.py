"""Independent replay audit for the conflict-penalty experiment."""
...
METRIC_FLOATS = (
    'value', 'q_rate', 'reward_rate', 'conditional_q_rate', 'target_pair_legal_rate',
...
def compare_metric(actual, saved):
    ...
    require(actual['penalty'] == saved['penalty'], 'Metric penalty mismatch')
...
def audit_seed(payload):
    ...
    for information in design.INFORMATIONS:
        ...
        for condition in design.CONDITIONS:
            ...
            final_checkpoint = directory / f'checkpoint_{runner.CONFIG["updates"]:04d}.npz'
