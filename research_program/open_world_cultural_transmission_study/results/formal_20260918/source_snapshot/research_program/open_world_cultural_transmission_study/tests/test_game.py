...
from research_program.open_world_cultural_transmission_study import design, environment, policy, runner
...
def main():
    ...
    assert design.parse_transfer_condition("factorized_aligned_hidden_expanded_single_sender") == (
        "factorized", "aligned", "hidden", "expanded_single_sender"
    )
    ...
    print("open_world_cultural_transmission_study tests passed")
