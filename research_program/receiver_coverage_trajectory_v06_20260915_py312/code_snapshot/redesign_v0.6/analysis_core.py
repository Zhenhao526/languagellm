"""Independent NumPy checks for the static v0.6 task; no policy imports.
...
def audit_static_arrays(arrays, *, n_sites, vocab, length, history_events,
    ...
    Array names follow the established v0.5 trace vocabulary. The report adapter
    must map any changed v0.6 names explicitly before calling this function.
