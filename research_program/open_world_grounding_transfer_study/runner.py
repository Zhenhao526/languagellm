...
def prepare(out):
    ...
    plan = {"schema": "open_world_grounding_transfer_study_v1", "prepared_sha256": sha(out / "prepared.json"),
...
def run_transfer_grid(prepared, expansion_execution, out, updates=None, seeds=None,
    ...
    for seed in seeds:
        for condition in conditions:
            architecture, population, visibility, _, _ = design.parse_transfer_condition(condition)
