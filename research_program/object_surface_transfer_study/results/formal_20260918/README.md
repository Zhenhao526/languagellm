...
Raw `training.jsonl` files and checkpoints were replay-audited and are intentionally not retained in the repository. `results.json`, `aggregate.json`, and `learning_curves.json` preserve per-run endpoints and compact dynamics.
