...
def main():
    output=HERE/'summary_comparison_002.json';assert not output.exists()
    ...
    eq(independent['status'],'passed','status');eq(summary['status'],'completed_read_only_summary','status')
