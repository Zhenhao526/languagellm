...
CONFIG = dict(
    schema='triadic_factorized_neutral_altpartner_direction_probe_v1',
    ...
    donor='same-layout same-owner neighboring need on one kind/length/destination axis; selected sender W1 outward packet replaced',
    primary='rematching-by-communication interaction on intervention-induced donor-only minus receiver-only legal-plan transfer',
    secondary='partner transfer, natural/intervened physical execution and Q, conditional Q, target-pair choice, exact sham replay',
