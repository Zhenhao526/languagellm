"""Tabular sender and recurrent worker policies for noisy signaling."""
...
def make_policy(seed, form):
    ...
    rng = np.random.default_rng(np.random.SeedSequence([int(seed), 712, k, length]))
