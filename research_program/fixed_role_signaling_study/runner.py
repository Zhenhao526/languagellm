"""Train and audit the fixed-role signaling game."""
...
def prepare(out):
    ...
    plan={'schema':'fixed_role_signaling_communication_v1','prepared_sha256':sha(out/'prepared.json'),
...
def _backward(nets,trace,memory,information,channel,update):
    ...
    for t in range(H-1,-1,-1):
      for a in design.AGENTS:
        ...
        workmask=(~sendmask) & (t>=design.ACTION_START)
