...
material types and persistent inventory. Agent 0 is the fixed scout and agent
1 is the fixed worker; both agents observe their role. The scout privately
...
wrong/depleted collection gives 0 and waiting gives 0. Inventory capacity
