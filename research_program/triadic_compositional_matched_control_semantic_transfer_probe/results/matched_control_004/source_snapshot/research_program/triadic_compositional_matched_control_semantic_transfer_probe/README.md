...
权威结果在 `results/matched_control_003/`，独立审计在 `audit_matched_control_003/`，完整说明见 [matched_control_结果与下一步.md](matched_control_结果与下一步.md)。`matched_control_002` 保留为审计脚本修复前的开发批次。
