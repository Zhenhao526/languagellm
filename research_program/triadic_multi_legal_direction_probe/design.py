"""Frozen case construction for the posthoc directional message probe."""
...
CONDITIONS = ('partial_multi_strict_PL_live', 'partial_multi_strict_PL_silent')
PARTS = ('new_layouts',)
CHECKPOINT = 6000
...
def make_prepared():
    ...
    return dict(schema='triadic_multi_legal_direction_probe_v1', seeds=list(SEEDS), conditions=list(CONDITIONS),
        ...
        scientific_question='Does replacing one sender W1 with a same-context neighboring need move recipients toward the donor legal plan?',
