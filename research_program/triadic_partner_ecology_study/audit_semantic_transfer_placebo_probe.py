"""Independent replay audit for the aligned/misaligned message placebo."""
...
def main(source, probe, output, workers=4):
    ...
    require(result["status"] == "completed_json_only_semantic_transfer_placebo_probe" and result["policy_blocks"] == 8 and result["intervention_rows"] == 1920, "Invalid result grid")
