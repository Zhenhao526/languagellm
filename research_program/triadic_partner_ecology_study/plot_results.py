        ...
        for mi,m in enumerate(METRICNAMES):
            for ii,info in enumerate(('PI','FI')):
                ...
                for j,(s,value,color,marker) in enumerate(zip(SEEDS,vals,COLORS,MARKERS)):
                    ...
                    ax.annotate(signed_display(value,3),(j,value),xytext=(0,8 if value>=-1e-10 else -16),textcoords='offset points',ha='center',fontsize=10,
                        bbox=dict(facecolor='white',edgecolor='none',alpha=.95,pad=.8))
