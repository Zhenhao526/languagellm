"""Frozen design for a structural factor-sharing test in referential games."""
...
def prepare():
    return {
        "schema":"structured_factorization_study_v1",
        "task":TASK,
        "form":{"name":FORM,"alphabet_size":ALPHABET_SIZE,"length":MESSAGE_LENGTH,"message_state_count":MESSAGE_STATE_COUNT},
        "architectures":list(ARCHITECTURES),
        "architecture_intervention":"holistic stores one sender/receiver row per complete meaning/message; factorized shares sender rows by attribute value and receiver scores additively by slot and attribute",
        ...
        "primary_readouts":["architecture effect on heldout combination/value return","live-minus-silent and natural-minus-permuted","cross-partner code consistency","slot-wise factor alignment and community conflict cost"],
