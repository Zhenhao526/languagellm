...
from research_program.triadic_receiver_role_crossover_study import runner as role_runner

from . import design

HERE = Path(__file__).resolve().parent
ROOT = HERE.parents[1]
SOURCE_RUN = ROOT / "research_program/triadic_receiver_role_crossover_study/results/role_crossover_003"
SOURCE_AUDIT = ROOT / "research_program/triadic_receiver_role_crossover_study/results/audit_role_crossover_004/verification.json"
