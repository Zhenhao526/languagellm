"""Staged environment with an explicit slot-local receiver state."""
...
def rollout_slot_local(params, ep, channel, *, message_mode="natural", sample=True, partner_filter=None):
