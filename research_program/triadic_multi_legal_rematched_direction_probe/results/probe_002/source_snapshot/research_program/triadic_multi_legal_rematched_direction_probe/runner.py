"""Run the posthoc W1 directional probe on final rematched multi-legal checkpoints."""
...
CONFIG = dict(schema='triadic_multi_legal_rematched_direction_probe_v1', seeds=list(SEEDS), conditions=list(CONDITIONS),
...
def frozen_inputs():
    ...
    result_path = SOURCE_RESULTS / 'analysis_002/results.json'
