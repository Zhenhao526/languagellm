"""Run the v3 environment-oracle task-competence gate."""
...
def main() -> None:
    ...
    run = run_condition(args.base_url, args.model, args.seed, "oracle_decoded",
                        args.temperature, args.max_tokens, args.timeout)
    payload = {
        "calibration_version": CALIBRATION_VERSION,
        "role": "task_competence_development_only_not_in_paired_matrix",
