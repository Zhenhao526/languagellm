"""Lightweight visual QA for the v0.47 reset-granularity figure."""
...
def run(out: Path):
    figure = out / "figures" / "01_reset_granularity.png"
    ...
    record = {
        ...
        "sha256": sha(figure),
        "checks": checks,
        "inspection": "six-panel reset-granularity figure rendered with English labels and no blank or missing-glyph regions",
    }
