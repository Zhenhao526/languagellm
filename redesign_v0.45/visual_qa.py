"""Lightweight visual QA for the v0.45 newcomer figure."""
...
def run(out: Path):
    ...
    record = {
        ...
        "sha256": sha(figure),
        "checks": checks,
        "inspection": "six-panel newcomer recovery figure rendered with English labels and no blank or missing-glyph regions",
    }
