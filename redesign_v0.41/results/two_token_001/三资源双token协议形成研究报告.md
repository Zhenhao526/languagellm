...
设计文件：[two_token_design.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.41/two_token_design.json)；执行绑定：[invocation.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.41/results/two_token_001/invocation.json)；训练完成：[training_complete.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.41/results/two_token_001/training_complete.json)。
...
|---|---|---:|---:|---:|
| 资源顺序 canonical | 固定 A | 0.440%（SD 0.589%） | 11.910%（SD 16.038%） | +11.470 个百分点 |
| 资源顺序 canonical | 轮换 A/B | 0.486%（SD 0.483%） | 25.150%（SD 8.561%） | +24.664 个百分点 |
| 资源顺序 canonical | 随机 A/B/C | 0.312%（SD 0.350%） | 32.766%（SD 5.220%） | +32.454 个百分点 |
| 资源顺序 cyclic（1→2→0） | 固定 A | 0.556%（SD 0.508%） | 12.049%（SD 16.226%） | +11.493 个百分点 |
| 资源顺序 cyclic（1→2→0） | 轮换 A/B | 0.382%（SD 0.391%） | 27.014%（SD 8.822%） | +26.632 个百分点 |
| 资源顺序 cyclic（1→2→0） | 随机 A/B/C | 0.451%（SD 0.450%） | 29.479%（SD 8.733%） | +29.028 个百分点 |
...
|---|---|---:|---:|---:|
| 资源顺序 canonical | 固定 A | 34.062%（SD 2.262%） | 0.208%（SD 0.377%） | 1.458%（SD 3.049%） |
| 资源顺序 canonical | 轮换 A/B | 29.618%（SD 6.237%） | 29.201%（SD 6.130%） | 16.632%（SD 6.156%） |
| 资源顺序 canonical | 随机 A/B/C | 32.882%（SD 5.387%） | 32.569%（SD 5.034%） | 32.847%（SD 5.679%） |
| 资源顺序 cyclic（1→2→0） | 固定 A | 34.444%（SD 3.845%） | 0.660%（SD 0.879%） | 1.042%（SD 1.158%） |
| 资源顺序 cyclic（1→2→0） | 轮换 A/B | 31.389%（SD 5.711%） | 31.389%（SD 5.568%） | 18.264%（SD 7.662%） |
| 资源顺序 cyclic（1→2→0） | 随机 A/B/C | 29.965%（SD 8.625%） | 28.368%（SD 9.985%） | 30.104%（SD 8.159%） |
...
|---|---|---:|---:|---:|---:|---:|
| 资源顺序 canonical | 固定 A | 94.896% | 78.077% | 100.000% | 93.207% | 7.190% |
| 资源顺序 canonical | 轮换 A/B | 93.015% | 77.438% | 100.000% | 91.401% | 6.579% |
| 资源顺序 canonical | 随机 A/B/C | 94.358% | 77.160% | 100.000% | 92.820% | 7.954% |
| 资源顺序 cyclic（1→2→0） | 固定 A | 96.418% | 77.697% | 100.000% | 95.373% | 8.122% |
| 资源顺序 cyclic（1→2→0） | 轮换 A/B | 94.896% | 77.817% | 100.000% | 93.681% | 7.620% |
| 资源顺序 cyclic（1→2→0） | 随机 A/B/C | 94.179% | 80.698% | 100.000% | 92.709% | 8.079% |
...
| 训练拓扑 | 评估 A | 评估 B | 评估 C |
|---|---:|---:|---:|
| 固定 A | +0.382 个百分点 | +0.451 个百分点 | -0.417 个百分点 |
| 轮换 A/B | +1.771 个百分点 | +2.187 个百分点 | +1.632 个百分点 |
| 随机 A/B/C | -2.917 个百分点 | -4.201 个百分点 | -2.743 个百分点 |
...
正式执行包含 72 条链、1200 次更新/链、3456 张协议表和 576 个轨迹文件。独立 NumPy 重分析通过 235400 项检查、41472 个标量比较，最大保存指标差异为 0.0；轨迹审计通过 467466 项检查，覆盖 576 个轨迹文件和 138240 行，最大重放误差为 9.5367431640625e-07。

结果图：[01_two_token_outcomes.png](/Users/xia/Documents/ChatGPT/语言/redesign_v0.41/results/two_token_001/figures/01_two_token_outcomes.png)；视觉 QA：[visual_qa.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.41/results/two_token_001/visual_qa.json)；图形元数据：[plot_metadata.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.41/results/two_token_001/plot_metadata.json)。
独立分析：[two_token_analysis.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.41/results/two_token_001/two_token_analysis.json)；重分析验证：[two_token_raw_validation.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.41/results/two_token_001/two_token_raw_validation.json)；轨迹审计：[two_token_audit.json](/Users/xia/Documents/ChatGPT/语言/redesign_v0.41/results/two_token_001/two_token_audit.json)。
训练源：[two_token_train.py](/Users/xia/Documents/ChatGPT/语言/redesign_v0.41/two_token_train.py)；分析源：[two_token_analysis.py](/Users/xia/Documents/ChatGPT/语言/redesign_v0.41/two_token_analysis.py)；审计源：[two_token_audit.py](/Users/xia/Documents/ChatGPT/语言/redesign_v0.41/two_token_audit.py)。
